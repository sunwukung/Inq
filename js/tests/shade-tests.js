...
test('style',function(){
    ...
    ok((shade.style(this.str) === false &&
        ...
        q.isO(shade.style(this.rgba))
        ), 'color.style returns false if first argument is not an array of three/four Numbers in range 0-255');
            console.log(shade.style(this.rgba, this.rgb));
            console.log(shade.style(this.rgb));
